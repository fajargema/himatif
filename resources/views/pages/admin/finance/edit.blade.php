...
<div class="card shadow mb-4">
    <div class="card-body">
        ...
        <form action="{{ route('dashboard.finance.update', $data->id) }}" method="POST">
            @method('PUT')
            @csrf
            ...
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <label>Jumlah</label>
                    <input type="int" class="form-control" name="jumlah" value="{{ old('jumlah') ?? $data->jumlah }}"
                ...
                <div class="col-sm-6">
                    ...
                    <select class="form-control" name="jenis">
                        ...
                        <option selected value="{{ $data->jenis }}">
                            {{ $data->jenis }} - <i>(Jenis Sekarang)</i>
                        </option>
